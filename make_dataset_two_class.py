...
def balancedataset(oversampled_targets, oversampled_dataset):
	...
	balanced_dataset = 	random.sample(rate1, n)+random.sample(rate5, n)
...
pickle.dump(balanced_targets, open( "targets_two_class.p", "wb" ) )
pickle.dump(balanced_dataset, open( "dataset_two_class.p", "wb" ) )
